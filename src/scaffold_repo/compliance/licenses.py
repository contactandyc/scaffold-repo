# src/scaffold_repo/compliance/licenses.py
...
# Import the comment styling logic from our new planner
from ..templating.planner import _comment_style_for, _ensure_trailing_newline, _OSS_HEADER_EXTS
